...
| salary      | int(11)  |
+-------------+----------+
We define an employee's total earnings to be their monthly  worked, and the maximum total earnings to be the maximum total earnings for any employee in Employee table. 
